<template>
  <div class="all-greads">
    ...
    <div class="gread-content">
      ...
      <div class="grades">
        <div class="item" v-for="item in gaozhong" :key="item.type">
          <p>我是</p>
          <h4>{{gradeitem.type}}</h4>
        </div>
        ...
        <div class="item item-chu">
          <p>我是</p>
          <h4>初一</h4>
        </div>
        <div class="item item-chu item-2">
          <p>我是</p>
          <h4>初一</h4>
        </div>
        <div class="item item-chu">
        ...
        <div class="item item-xiao">
          <p>我是</p>
          <h4>一年级</h4>
        </div>
        <div class="item item-xiao item-2">
          <p>我是</p>
          <h4>二年级</h4>
        </div>
