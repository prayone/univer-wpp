  ...
  methods: {
    ...
    getLinkApi() {
      getLink({ key: "allgrad" }).then((res) => {
        ...
        console.log("--this.gaozhong", JSON.stringify(this.gaozhong));
        console.log("--this.gaozhong", JSON.stringify(this.chuzhong));
        console.log("--this.gaozhong", JSON.stringify(this.xiaoxue));
      });
    },
  },
};
